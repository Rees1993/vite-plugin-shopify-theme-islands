...
Triaged `needs-triage` → `ready-for-agent`. ADR-0003 captures the architectural rationale (partial revert of v2.0 extraction); the slice itself is file deletion + 5 call-site updates.
