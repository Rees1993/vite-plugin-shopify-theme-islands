...
Triaged `needs-triage` → `ready-for-agent`. ADR-0002 captures the architectural rationale (partial revert of v2.0 extraction); the slice itself is mechanical interface narrowing.
